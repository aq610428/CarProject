 ...
 * @name:清单
 */
public class ClientNewAdapter extends BaseAdapter {
    private List<KeepInfo> inventories = new ArrayList<>();
    private Context mContext;

    public ClientNewAdapter(Context context, List<KeepInfo> inventories) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            vh = new ViewHolder();
            convertView = View.inflate(mContext, R.layout.item_keep_client, null);
